...
**data_received**\ (\ arg1\: :ref:`PackedByteArray<class_PackedByteArray>`, arg2\: :ref:`GKPlayer<class_GKPlayer>`\ ) :ref:`🔗<class_GKMatch_signal_data_received>`
...
**data_received_for_recipient_from_player**\ (\ arg1\: :ref:`PackedByteArray<class_PackedByteArray>`, arg2\: :ref:`GKPlayer<class_GKPlayer>`, arg3\: :ref:`GKPlayer<class_GKPlayer>`\ ) :ref:`🔗<class_GKMatch_signal_data_received_for_recipient_from_player>`
...
**did_fail_with_error**\ (\ arg1\: :ref:`String<class_String>`\ ) :ref:`🔗<class_GKMatch_signal_did_fail_with_error>`
...
**player_changed**\ (\ arg1\: :ref:`GKPlayer<class_GKPlayer>`, arg2\: :ref:`bool<class_bool>`\ ) :ref:`🔗<class_GKMatch_signal_player_changed>`
...
enum **SendDataMode**: :ref:`🔗<enum_GKMatch_SendDataMode>`
...
:ref:`int<class_int>` **expected_player_count** = ``0`` :ref:`🔗<class_GKMatch_property_expected_player_count>`
...
:ref:`Array<class_Array>` **players** = ``[]`` :ref:`🔗<class_GKMatch_property_players>`
...
:ref:`Variant<class_Variant>` **should_reinvite_disconnected_player** :ref:`🔗<class_GKMatch_property_should_reinvite_disconnected_player>`
...
|void| **disconnect**\ (\ ) :ref:`🔗<class_GKMatch_method_disconnect>`
...
:ref:`int<class_int>` **send**\ (\ data\: :ref:`PackedByteArray<class_PackedByteArray>`, toPlayers\: :ref:`Array<class_Array>`, dataMode\: :ref:`SendDataMode<enum_GKMatch_SendDataMode>`\ ) :ref:`🔗<class_GKMatch_method_send>`

Sends a payload to the specified ``Array[GKPlayer]``. Returns a :ref:`Error<enum_@GlobalScope_Error>` value (``OK`` on success, ``FAILED`` when the payload could not be converted or Apple reported an error).
...
:ref:`int<class_int>` **send_data_to_all_players**\ (\ data\: :ref:`PackedByteArray<class_PackedByteArray>`, dataMode\: :ref:`SendDataMode<enum_GKMatch_SendDataMode>`\ ) :ref:`🔗<class_GKMatch_method_send_data_to_all_players>`

Broadcasts the packed bytes to everyone in the match. Return value matches :ref:`send()<class_GKMatch_method_send>`.
